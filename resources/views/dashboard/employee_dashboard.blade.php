            ...
            <div class="col-12 col-md-12 col-lg-12 col-xxl-12">
                <div class="row gy-5 gx-5">
                    <div class="col-12 col-lg-6 col-xxl-6">
                        <div class="card overflow-hidden mb-0 h-100">
                            <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <div class="card-body position-relative overflow-auto" style="max-height: 298px; min-height: 298px;">
                                <div class="row gy-5 gx-5">
                    ...
                    <div class="col-12 col-lg-6 col-xxl-6">
                        <div class="card overflow-hidden mb-0 h-100">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ Route('tasks') }}" class="btn btn-sm border-primary bg-label-primary">
                                    View All <i class="mdi mdi-arrow-right"></i>
                                </a>
                            </div>
                            <div
                                class="card-body position-relative overflow-auto d-flex justify-content-start align-items-start" style="max-height: 298px; min-height: 298px;">
