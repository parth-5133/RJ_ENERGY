...
class DepartmentController extends Controller
{
    ...
    {
        $request->merge(['AccessCode' => config('menuAccessCode.DEPARTMENT')]);
        ...
        return view('department.department_index', ['permissions' => $permissions, 'menuName' => $menuName]);
    }
    public function create(Request $request)
    {
        $departmentId = $request->input('id');

        return view('department.department_create', compact('departmentId'));
    }
}
